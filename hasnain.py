...
\033[1;91m☞ Auther     : B4_hasnain_M4_MASTER
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/B4_hasnain)
	    os.system('cd $HOME && git clone https://github.com/hasnain125/hasnain')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To B4_hasnain)
	    psb('Congratulations B4_hasnain Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 789789✓')
	    psb('🔓Password ☆ 789789✓')
	    psb('Subscrib My Youtube Channel B4 hasnain M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/B4_hasnain && python2 hasnain.py')
	elif bm =='3':
